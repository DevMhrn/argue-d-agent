...
const MOCK: Record<string, unknown> = {
  ...
  ledger: {
    ...
    facts: [
      { id: 'F1', statement: 'Driver B entered the intersection against a steady red light.', source: 'police_report.pdf p.2 ¶3', confidence: 0.9 },
      { id: 'F2', statement: 'Two independent witnesses estimated Driver B was traveling ~50 mph in a 35 mph zone.', source: 'witness_statements.pdf', confidence: 0.75 },
      { id: 'F3', statement: 'Driver A entered the intersection on a green light.', source: 'signal_timing_log.csv; police_report.pdf p.2', confidence: 0.85 },
      { id: 'F4', statement: 'Police cited Driver B for running a red light (CVC 21453).', source: 'police_report.pdf p.4', confidence: 0.95 },
      { id: 'F5', statement: "Driver A's event data recorder shows Driver A traveling 40 mph in a 35 mph zone (5 mph over).", source: 'edr_readout.pdf', confidence: 0.8 },
      { id: 'F6', statement: 'Total repair and medical damages to Driver A: $42,000.', source: 'repair_invoice.pdf; medical_bills.pdf', confidence: 0.95 },
    ],
  },
