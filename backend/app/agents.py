...
AGENTS: dict[str, AgentDef] = {
    ...
    "adjudicator_b": AgentDef("adjudicator_b", "Adjudicator B", "Independent adjudicator on a different family (GPT)", "openai", MODELS["adjudicator_b"], P.ADJUDICATOR_PROMPT, 214),
    "verifier": AgentDef("verifier", "Source-Alignment Verifier", "Audit every cited claim against its source fact", "anthropic", MODELS["verifier"], P.VERIFIER_PROMPT, 105),
