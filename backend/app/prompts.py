"""Agent system prompts (ported from src/prompts.ts).

These bake in the anti-hallucination and anti-collusion rules. The two debaters
have strictly opposing, fixed objectives and are NEVER told to reach agreement.
"""
